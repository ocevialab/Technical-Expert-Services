...
const REVEAL_START = "top bottom-=26%";

const PAGE_GUTTER = "px-8 sm:px-10 lg:px-14 xl:px-16";
const BAND_PY = "py-14 sm:py-20";
const CONTACT_HERO_IMG = "/assets/contactuspage.jpg";
const FAQ_SIDE_IMG = "/assets/contactusImage2.jpg";
...
export default function ContactPageClient() {
  return (
    <>
      ...
      >
        <div className="pointer-events-none absolute inset-0 z-0" aria-hidden>
          <Image
            ...
            priority
            sizes="100vw"
            className="object-cover object-[center_38%] opacity-[0.48] sm:object-center"
          />
          <div
        ...
        <RevealParts triggerStart={REVEAL_START} className="relative z-10">
          <div className="relative mx-auto max-w-3xl [text-shadow:0_2px_32px_rgba(5,31,50,0.72),0_1px_6px_rgba(5,31,50,0.55)]">
            <h1
              data-reveal
              className="text-3xl font-normal leading-tight sm:text-4xl md:text-5xl lg:text-[3.15rem]"
            >
              Get in touch
            </h1>
            <p
      ...
      >
        <RevealParts triggerStart={REVEAL_START}>
          <div className="grid w-full gap-10 lg:grid-cols-2 lg:gap-12 xl:gap-16">
            <div data-reveal className="lg:max-w-xl xl:max-w-2xl">
      ...
      >
        <RevealParts triggerStart={REVEAL_START}>
          <div className="grid w-full items-stretch gap-10 lg:grid-cols-2 lg:gap-12 xl:gap-16">
            <div data-reveal className="flex h-full w-full flex-col lg:min-h-0">
              <div className="relative aspect-4/3 w-full min-h-0 flex-1 overflow-hidden rounded-xl border border-primary-100 bg-white/90 shadow-card lg:aspect-auto lg:min-h-56">
                <Image
                  src={FAQ_SIDE_IMG}
                  alt="Customer support team ready to help with your enquiry"
                  fill
