...
export default function ServicesPage() {
  return (
    <>
      ...
      >
        <RevealParts triggerStart={REVEAL_SERVICES}>
          <div className="w-full">
            <div className="grid items-start gap-10 lg:grid-cols-2 lg:gap-12 xl:gap-16">
              <div className="order-2 flex flex-col pt-1 lg:order-1 lg:max-w-xl xl:max-w-2xl">
                ...
                <p data-reveal className="mt-5 text-base leading-relaxed text-neutral-700">
                ...
                <ul className="mt-8 space-y-3.5">
                  {paintingIntroBullets.map((line) => (
                    <li
                      key={line}
                      data-reveal
                      className="flex gap-3 text-base leading-relaxed text-brand-navy"
                    >
              ...
              <div className="order-1 lg:order-2">
                <div
                  data-reveal
                  className="relative aspect-[4/3] w-full overflow-hidden rounded-2xl border border-primary-100/90 shadow-card lg:aspect-auto lg:h-[clamp(17rem,30vw,24rem)] lg:max-w-none"
                >
                  <Image
                    src={PAINTING_IMG}
      ...
      >
        <RevealParts triggerStart={REVEAL_SERVICES}>
          <div className="w-full">
            ...
            <h2
              data-reveal
              className="max-w-2xl text-3xl font-normal leading-tight text-brand-navy md:text-4xl"
            >
              Residential and commercial painting
            </h2>
            <p data-reveal className="mt-4 max-w-2xl leading-relaxed text-neutral-600">
          ...
          <div className="w-full">
            <div className="grid items-start gap-10 lg:grid-cols-2 lg:gap-12 xl:gap-16">
              <div className="order-1">
                <div
                  data-reveal
                  className="relative aspect-[4/3] w-full overflow-hidden rounded-2xl border border-primary-100/90 shadow-card lg:aspect-auto lg:h-[clamp(17rem,30vw,24rem)]"
                >
                  <Image
                    src={PLUMBING_IMG}
      ...
      <section className={`home-band-a ${PAGE_GUTTER} ${BAND_PY}`}>
        <RevealParts triggerStart={REVEAL_SERVICES}>
          <div className="mx-auto max-w-2xl text-center">
            <div data-reveal className="mx-auto mb-5 flex justify-center text-brand-asset">
