    ...
    <div className="flex h-full min-h-64 w-full flex-col overflow-hidden rounded-2xl border border-primary-100 bg-neutral-950 shadow-card sm:min-h-72 md:h-full">
      <div className="relative min-h-52 w-full flex-1 overflow-hidden bg-neutral-900 sm:min-h-56 md:min-h-64 lg:min-h-72">
        ...
        <div className="pointer-events-auto absolute inset-x-0 bottom-0 z-10 flex items-center justify-between gap-3 px-4 py-3.5">
          ...
          <Link
            href="/about"
            className="inline-flex shrink-0 items-center gap-1.5 text-xs font-semibold text-accent-200 drop-shadow-md underline-offset-2 hover:text-white hover:underline sm:text-sm"
          >
            About us
